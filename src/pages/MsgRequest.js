...
import { get_patient, get_patient_contact, get_unknown_contact } from '../redux/slice/patients';
                    ...
                    <div className='ext-cls'>
                        <div className='patient_contact'>
                            ...
                            <div className='all-patient'>
                                ...
                                {loading === "unknown" ? <div style={{ paddingLeft: "21px", paddingTop: "192px", width: "100px", margin: "auto" }}>
                                    <Spinner animation="border" variant="primary" />
                                </div> :
                                    unknown_contact && unknown_contact.map((it) => {
